...
public abstract class PluginSkeleton implements IPlugin {
  ...
  public java.lang.String getName() {
    try {
      java.lang.String res =
          javonetHandle.explicitInterface("log4net.Plugin.IPlugin").invoke("get_Name");
      if (res == null) return "";
  ...
  public PluginSkeleton(NObject handle) {
