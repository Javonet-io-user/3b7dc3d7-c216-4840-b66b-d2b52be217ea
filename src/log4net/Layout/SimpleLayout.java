...
public class SimpleLayout extends LayoutSkeleton implements ILayout, IOptionHandler {
  protected NObject javonetHandle;

  public SimpleLayout() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("log4net.Layout.SimpleLayout");
  ...
  public SimpleLayout(NObject handle) {
    super(handle);
