...
public class RawUtcTimeStampLayout implements IRawLayout {
  protected NObject javonetHandle;

  public RawUtcTimeStampLayout() {
    try {
      javonetHandle = Javonet.New("log4net.Layout.RawUtcTimeStampLayout");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public RawUtcTimeStampLayout(NObject handle) {
