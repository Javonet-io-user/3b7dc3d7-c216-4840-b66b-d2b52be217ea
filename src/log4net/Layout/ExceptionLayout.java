...
public class ExceptionLayout extends LayoutSkeleton implements ILayout, IOptionHandler {
  protected NObject javonetHandle;

  public ExceptionLayout() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("log4net.Layout.ExceptionLayout");
  ...
  public ExceptionLayout(NObject handle) {
    super(handle);
