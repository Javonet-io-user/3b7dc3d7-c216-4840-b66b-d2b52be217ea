...
public class NullEnumerator implements IEnumerator {
  protected NObject javonetHandle;
  /** GetProperty */
  public static NullEnumerator getInstance() {
    try {
      Object res = Javonet.getType("NullEnumerator").<NObject>get("Instance");
      if (res == null) return null;
      return new NullEnumerator((NObject) res);
  ...
  public NullEnumerator(NObject handle) {
