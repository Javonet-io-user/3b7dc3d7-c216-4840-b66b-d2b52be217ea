...
public class EmptyCollection implements ICollection, IEnumerable, Iterable<Object> {
  ...
  public static EmptyCollection getInstance() {
    try {
      Object res = Javonet.getType("EmptyCollection").<NObject>get("Instance");
      if (res == null) return null;
      return new EmptyCollection((NObject) res);
  ...
  public EmptyCollection(NObject handle) {
