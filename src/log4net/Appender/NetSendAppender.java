...
public class NetSendAppender extends AppenderSkeleton
  ...
  public void setSender(java.lang.String value) {
    try {
      javonetHandle.set("Sender", value);
  ...
  public java.lang.String getSender() {
    try {
      java.lang.String res = javonetHandle.get("Sender");
      if (res == null) return "";
  ...
  public void setRecipient(java.lang.String value) {
    try {
      javonetHandle.set("Recipient", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getRecipient() {
    try {
      java.lang.String res = javonetHandle.get("Recipient");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setServer(java.lang.String value) {
    try {
      javonetHandle.set("Server", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public NetSendAppender() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("log4net.Appender.NetSendAppender");
  ...
  public NetSendAppender(NObject handle) {
    super(handle);
