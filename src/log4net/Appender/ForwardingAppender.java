...
public class ForwardingAppender extends AppenderSkeleton
  ...
  public ForwardingAppender() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("log4net.Appender.ForwardingAppender");
  ...
  public ForwardingAppender(NObject handle) {
    super(handle);
