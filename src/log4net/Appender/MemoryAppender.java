...
public class MemoryAppender extends AppenderSkeleton
  ...
  public MemoryAppender() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("log4net.Appender.MemoryAppender");
  ...
  public MemoryAppender(NObject handle) {
    super(handle);
  ...
  public LoggingEvent[] GetEvents(Class<?> returnArrayType) {
    try {
      Object[] res = javonetHandle.invoke("GetEvents");
      if (res == null) return null;
