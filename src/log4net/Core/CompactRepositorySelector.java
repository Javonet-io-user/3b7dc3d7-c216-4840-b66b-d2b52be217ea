...
public class CompactRepositorySelector implements IRepositorySelector {
  protected NObject javonetHandle;

  public CompactRepositorySelector(jio.System.Type defaultRepositoryType) {
    try {
      javonetHandle = Javonet.New("log4net.Core.CompactRepositorySelector", defaultRepositoryType);
  ...
  public CompactRepositorySelector(NObject handle) {
  ...
  public ILoggerRepository CreateRepository(Assembly assembly, jio.System.Type repositoryType) {
    try {
      Object res =
          javonetHandle
              .explicitInterface("log4net.Core.IRepositorySelector")
              .invoke("CreateRepository", assembly, repositoryType);
      if (res == null) return null;
      return ConvertToConcreteInterfaceImplementation(res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
