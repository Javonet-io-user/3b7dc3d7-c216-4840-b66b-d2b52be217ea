...
public class DenyAllFilter extends FilterSkeleton implements IFilter, IOptionHandler {
  protected NObject javonetHandle;

  public DenyAllFilter() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("log4net.Filter.DenyAllFilter");
  ...
  public DenyAllFilter(NObject handle) {
    super(handle);
