...
public class LevelMatchFilter extends FilterSkeleton implements IFilter, IOptionHandler {
  ...
  public void setLevelToMatch(Level value) {
    try {
      javonetHandle.set("LevelToMatch", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Level getLevelToMatch() {
    try {
      Object res = javonetHandle.<NObject>get("LevelToMatch");
  ...
  public LevelMatchFilter() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("log4net.Filter.LevelMatchFilter");
  ...
  public LevelMatchFilter(NObject handle) {
    super(handle);
