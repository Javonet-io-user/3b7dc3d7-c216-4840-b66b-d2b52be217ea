...
public class PropertyFilter extends StringMatchFilter implements IFilter, IOptionHandler {
  ...
  public PropertyFilter() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("log4net.Filter.PropertyFilter");
  ...
  public PropertyFilter(NObject handle) {
    super(handle);
