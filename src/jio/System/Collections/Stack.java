...
public class Stack implements ICollection, IEnumerable, ICloneable, Iterable<Object> {
  ...
  public Stack() {
    try {
      javonetHandle = Javonet.New("System.Collections.Stack");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Stack(java.lang.Integer initialCapacity) {
    try {
      javonetHandle = Javonet.New("System.Collections.Stack", initialCapacity);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Stack(ICollection col) {
    try {
      javonetHandle = Javonet.New("System.Collections.Stack", col);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.Boolean Contains(Object obj) {
    try {
      java.lang.Boolean res = javonetHandle.invoke("Contains", obj);
      if (res == null) return false;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public static Stack Synchronized(Stack stack) {
    try {
      Object res = Javonet.getType("Stack").invoke("Synchronized", stack);
      if (res == null) return null;
  ...
  public Object[] ToArray(Class<?> returnArrayType) {
    try {
